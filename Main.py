...
def read_board_from_file(filename):
    ...
    tournamentSize = int(ga_params_line[3])
    crossoverRate = float(ga_params_line[4])
    mutationRate = float(ga_params_line[5])
    
    return size, board, popSize, maxGenCount, elitismRate, tournamentSize, crossoverRate, mutationRate
...
def main():
    ...
    try:
        size, board, popSize, maxGenCount, elitismRate, tournamentSize, crossoverRate, mutationRate = read_board_from_file(input_file)
